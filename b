...
function Xenon.Utils:Stats()
    ...
    if self:GetState("Rib Farm") == true or self:GetState("Rib Shiny Farm") == true then
        table.insert(Skills, #Skills+1, "Worthiness")
    end
...
Util:AddValues{
    ...
    ["Table"] = {
        ...
        AllItems = {"Red Candy", "Blue Candy", "Yellow Candy", "Green Candy", "Christmas Present", "Mysterious Arrow", "Pure Rokakaka", "Rokakaka", "Diamond", "Lucky Arrow", "Lucky Stone Mask", "Dio's Diary", "Steel Ball", "Rib Cage of The Saint's Corpse", "Stone Mask", "Gold Coin", "Quinton's Glove", "Ancient Scroll", "Zeppeli's Headband"};
...
Autofarms_StandFarm:Button("Buy 5x Rokakaka ($8000)", function()
    Util:GetCharacter().RemoteEvent:FireServer("PurchaseShopItem", {["ItemName"] = "5x Rokakaka"}, 1, 2)
end, "buys tea")

Autofarms_StandFarm:Button("Buy 5x Mysterious Arrow ($2250)", function()
...
Misc_Other:Button("Buy 5x Rokakaka ($8000)", function()
    Util:GetCharacter().RemoteEvent:FireServer("PurchaseShopItem", {["ItemName"] = "5x Rokakaka"}, 1, 2)
end, "buys tea")
...
Misc_Other:Button("Buy 5x Mysterious Arrow ($2250)", function()
    Util:GetCharacter().RemoteEvent:FireServer("PurchaseShopItem", {["ItemName"] = "5x Mysterious Arrow"}, 1, 2)
end, "buys tea")
